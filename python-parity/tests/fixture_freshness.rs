...
const VERSIONED_FIXTURES: [&str; 20] = [
    "data/key_analysis_expectations.toml",
    "data/ornament_expectations.toml",
    "data/articulation_expectations.toml",
    "data/clef_expectations.toml",
    ...
    "data/roman_figure_expectations.toml",
