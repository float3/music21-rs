...
(function () {
    ...
    const list = document.querySelector<HTMLElement>("[data-class-list]");
    const search = document.querySelector<HTMLInputElement>("[data-filter-search]");
    const incomplete = document.querySelector<HTMLInputElement>("[data-filter-incomplete]");
    const tally = document.querySelector<HTMLElement>("[data-filter-tally]");
    const expand = document.querySelector<HTMLElement>("[data-expand-all]");
    const collapse = document.querySelector<HTMLElement>("[data-collapse-all]");
