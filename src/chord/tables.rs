...
lazy_static! {
    ...
    pub(crate) static ref TN_INDEX_TO_CHORD_INFO: HashMap<(u8, u8, i8), Vec<&'static str>> = {
        let mut m = HashMap::new();
        m.insert((1, 1, 0), vec!["unison", "monad", "singleton"]);
        m.insert((2, 1, 0), vec!["interval class 1", "minor second", "m2", "half step", "semitone"]);
        m.insert((2, 2, 0), vec!["interval class 2", "major second", "M2", "whole step", "whole tone"]);
        m.insert((2, 3, 0), vec!["interval class 3", "minor third", "m3"]);
        m.insert((2, 4, 0), vec!["interval class 4", "major third", "M3"]);
        m.insert((2, 5, 0), vec!["interval class 5", "perfect fourth", "P4"]);
        m.insert((2, 6, 0), vec!["tritone", "diminished fifth", "augmented fourth"]);
        m.insert((3, 1, 0), vec!["chromatic trimirror"]);
        m.insert((3, 2, 1), vec!["phrygian trichord"]);
        m.insert((3, 2, -1), vec!["minor trichord"]);
        m.insert((3, 3, 1), vec!["major-minor trichord"]);
        m.insert((3, 3, -1), vec!["major-minor trichord"]);
        m.insert((3, 4, 1), vec!["incomplete major-seventh chord"]);
        m.insert((3, 4, -1), vec!["incomplete major-seventh chord"]);
        m.insert((3, 5, 1), vec!["tritone-fourth"]);
        m.insert((3, 5, -1), vec!["tritone-fourth"]);
        m.insert((3, 6, 0), vec!["whole-tone trichord"]);
        m.insert((3, 7, 1), vec!["incomplete minor-seventh chord"]);
        m.insert((3, 7, -1), vec!["incomplete dominant-seventh chord"]);
        m.insert((3, 8, 1), vec!["incomplete dominant-seventh chord", "Italian augmented sixth chord"]);
        m.insert((3, 8, -1), vec!["incomplete half-diminished seventh chord"]);
        m.insert((3, 9, 0), vec!["quartal trichord"]);
        m.insert((3, 10, 0), vec!["diminished triad"]);
        m.insert((3, 11, 1), vec!["minor triad"]);
        m.insert((3, 11, -1), vec!["major triad"]);
        m.insert((3, 12, 0), vec!["augmented triad", "equal 3-part octave division"]);
        m.insert((4, 1, 0), vec!["chromatic tetramirror", "BACH"]);
        m.insert((4, 2, 1), vec!["major-second tetracluster"]);
        m.insert((4, 2, -1), vec!["major-second tetracluster"]);
        m.insert((4, 3, 0), vec!["alternating tetramirror"]);
        m.insert((4, 4, 1), vec!["minor third tetracluster"]);
        m.insert((4, 4, -1), vec!["minor third tetracluster"]);
        m.insert((4, 5, 1), vec!["major third tetracluster"]);
        m.insert((4, 5, -1), vec!["major third tetracluster"]);
        m.insert((4, 6, 0), vec!["perfect fourth tetramirror"]);
        m.insert((4, 7, 0), vec!["Arabian tetramirror"]);
        m.insert((4, 8, 0), vec!["double-fourth tetramirror"]);
        m.insert((4, 9, 0), vec!["double tritone tetramirror"]);
        m.insert((4, 10, 0), vec!["minor tetramirror"]);
        m.insert((4, 11, 1), vec!["phrygian tetrachord"]);
        m.insert((4, 11, -1), vec!["lydian tetrachord", "major tetrachord"]);
        m.insert((4, 12, 1), vec!["harmonic minor tetrachord"]);
        m.insert((4, 12, -1), vec!["major-third diminished tetrachord"]);
        m.insert((4, 13, 1), vec!["minor-second diminished tetrachord"]);
        m.insert((4, 13, -1), vec!["perfect-fourth diminished tetrachord"]);
        m.insert((4, 14, 1), vec!["major-second minor tetrachord"]);
        m.insert((4, 14, -1), vec!["perfect-fourth major tetrachord"]);
        m.insert((4, 15, 1), vec!["all-interval tetrachord"]);
        m.insert((4, 15, -1), vec!["all-interval tetrachord"]);
        m.insert((4, 16, 1), vec!["minor-second quartal tetrachord"]);
        m.insert((4, 16, -1), vec!["tritone quartal tetrachord"]);
        m.insert((4, 17, 0), vec!["major-minor tetramirror"]);
        m.insert((4, 18, 1), vec!["major-diminished tetrachord"]);
        m.insert((4, 18, -1), vec!["minor-diminished tetrachord"]);
        m.insert((4, 19, 1), vec!["minor-augmented tetrachord"]);
        m.insert((4, 19, -1), vec!["augmented major tetrachord"]);
        m.insert((4, 20, 0), vec!["major seventh chord"]);
        m.insert((4, 21, 0), vec!["whole-tone tetramirror"]);
        m.insert((4, 22, 1), vec!["major-second major tetrachord"]);
        m.insert((4, 22, -1), vec!["perfect-fourth minor tetrachord"]);
        m.insert((4, 23, 0), vec!["quartal tetramirror"]);
        m.insert((4, 24, 0), vec!["augmented seventh chord"]);
        m.insert((4, 25, 0), vec!["Messiaen's truncated mode 6", "French augmented sixth chord"]);
        m.insert((4, 26, 0), vec!["minor seventh chord"]);
        m.insert((4, 27, 1), vec!["half-diminished seventh chord"]);
        m.insert((4, 27, -1), vec!["dominant seventh chord", "major minor seventh chord", "German augmented sixth chord", "Swiss augmented sixth chord"]);
        m.insert((4, 28, 0), vec!["diminished seventh chord", "equal 4-part octave division"]);
        m.insert((4, 29, 1), vec!["all-interval tetrachord"]);
        m.insert((4, 29, -1), vec!["all-interval tetrachord"]);
        m.insert((5, 1, 0), vec!["chromatic pentamirror"]);
        m.insert((5, 2, 1), vec!["major-second pentacluster"]);
        m.insert((5, 2, -1), vec!["major-second pentacluster"]);
        m.insert((5, 3, 1), vec!["minor-second major pentachord"]);
        m.insert((5, 3, -1), vec!["Spanish pentacluster"]);
        m.insert((5, 4, 1), vec!["blues pentacluster"]);
        m.insert((5, 4, -1), vec!["minor-third pentacluster"]);
        m.insert((5, 5, 1), vec!["major-third pentacluster"]);
        m.insert((5, 5, -1), vec!["major-third pentacluster"]);
        m.insert((5, 6, 1), vec!["Asian pentacluster", "quasi raga Megharanji"]);
        m.insert((5, 6, -1), vec!["Asian pentacluster"]);
        m.insert((5, 7, 1), vec!["double pentacluster", "quasi raga Nabhomani"]);
        m.insert((5, 7, -1), vec!["double pentacluster"]);
        m.insert((5, 8, 0), vec!["tritone-symmetric pentamirror"]);
        m.insert((5, 9, 1), vec!["tritone-expanding pentachord"]);
        m.insert((5, 9, -1), vec!["tritone-contracting pentachord"]);
        m.insert((5, 10, 1), vec!["alternating pentachord"]);
        m.insert((5, 10, -1), vec!["alternating pentachord"]);
        m.insert((5, 11, 1), vec!["center-cluster pentachord"]);
        m.insert((5, 11, -1), vec!["center-cluster pentachord"]);
        m.insert((5, 12, 0), vec!["locrian pentachord"]);
        m.insert((5, 13, 1), vec!["augmented pentacluster"]);
        m.insert((5, 13, -1), vec!["augmented pentacluster"]);
        m.insert((5, 14, 1), vec!["double-seconds triple-fourth pentachord"]);
        m.insert((5, 14, -1), vec!["double-seconds triple-fourth pentachord"]);
        m.insert((5, 15, 0), vec!["asymmetric pentamirror"]);
        m.insert((5, 16, 1), vec!["major-minor-diminished pentachord"]);
        m.insert((5, 16, -1), vec!["major-minor diminished pentachord"]);
        m.insert((5, 17, 0), vec!["minor-major ninth chord"]);
        m.insert((5, 18, 1), vec!["Roma (Gypsy) pentachord"]);
        m.insert((5, 18, -1), vec!["Roma (Gypsy) pentachord"]);
        m.insert((5, 19, 1), vec!["Javanese pentachord"]);
        m.insert((5, 19, -1), vec!["Balinese pentachord"]);
        m.insert((5, 20, 1), vec!["Balinese Pelog pentatonic", "quasi raga Bhupala", "quasi raga Bibhas"]);
        m.insert((5, 20, -1), vec!["Hirajoshi pentatonic", "Iwato", "Sakura", "quasi raga Saveri"]);
        m.insert((5, 21, 1), vec!["major-augmented ninth chord", "Syrian pentatonic", "quasi raga Megharanji"]);
        m.insert((5, 21, -1), vec!["Lebanese pentachord", "augmented-minor chord"]);
        m.insert((5, 22, 0), vec!["Persian pentamirror", "quasi raga Ramkali"]);
        m.insert((5, 23, 1), vec!["dorian pentachord", "minor pentachord"]);
        m.insert((5, 23, -1), vec!["major pentachord"]);
        m.insert((5, 24, 1), vec!["phrygian pentachord"]);
        m.insert((5, 24, -1), vec!["lydian pentachord"]);
        m.insert((5, 25, 1), vec!["diminished-major ninth chord"]);
        m.insert((5, 25, -1), vec!["minor-diminished ninth chord"]);
        m.insert((5, 26, 1), vec!["diminished-augmented ninth chord"]);
        m.insert((5, 26, -1), vec!["augmented-diminished ninth chord"]);
        m.insert((5, 27, 1), vec!["major-ninth chord"]);
        m.insert((5, 27, -1), vec!["minor-ninth chord"]);
        m.insert((5, 28, 1), vec!["augmented-sixth pentachord"]);
        m.insert((5, 28, -1), vec!["Javanese pentatonic", "augmented-sixth pentachord"]);
        m.insert((5, 29, 1), vec!["Kumoi pentachord"]);
        m.insert((5, 29, -1), vec!["Kumoi pentachord"]);
        m.insert((5, 30, 1), vec!["enigmatic pentachord"]);
        m.insert((5, 30, -1), vec!["enigmatic pentachord", "altered pentatonic"]);
        m.insert((5, 31, 1), vec!["diminished minor-ninth chord"]);
        m.insert((5, 31, -1), vec!["flat-ninth pentachord", "quasi raga Ranjaniraga"]);
        m.insert((5, 32, 1), vec!["Neapolitan pentachord"]);
        m.insert((5, 32, -1), vec!["Neapolitan pentachord"]);
        m.insert((5, 33, 0), vec!["whole-tone pentachord"]);
        m.insert((5, 34, 0), vec!["dominant-ninth", "major-minor", "Prometheus pentamirror", "dominant pentatonic"]);
        m.insert((5, 35, 0), vec!["major pentatonic", "black-key scale", "blues pentatonic", "slendro", "quartal pentamirror"]);
        m.insert((5, 36, 1), vec!["major-seventh pentacluster"]);
        m.insert((5, 36, -1), vec!["minor-seventh pentacluster"]);
        m.insert((5, 37, 0), vec!["center-cluster pentamirror"]);
        m.insert((5, 38, 1), vec!["diminished pentacluster"]);
        m.insert((5, 38, -1), vec!["diminished pentacluster"]);
        m.insert((6, 1, 0), vec!["A all combinatorial (P6, I11, RI5, RI11)", "chromatic hexamirror", "first-order all-combinatorial"]);
        m.insert((6, 2, 1), vec!["combinatorial I (I11)"]);
        m.insert((6, 2, -1), vec!["combinatorial I (I1)"]);
        m.insert((6, 4, 0), vec!["combinatorial RI (RI6)"]);
        m.insert((6, 5, 1), vec!["combinatorial I (I11)"]);
        m.insert((6, 5, -1), vec!["combinatorial I (I3)"]);
        m.insert((6, 6, 0), vec!["double cluster hexamirror"]);
        m.insert((6, 7, 0), vec!["B all combinatorial (P3, P9, I5, R6, R12, R8)", "Messiaen's mode 5", "second-order all combinatorial"]);
        m.insert((6, 8, 0), vec!["D all combinatorial (P6, I1, RI7)"]);
        m.insert((6, 9, 1), vec!["combinatorial I (I11)"]);
        m.insert((6, 9, -1), vec!["combinatorial I (I3)"]);
        m.insert((6, 13, 0), vec!["alternating hexamirror", "combinatorial I (I7)"]);
        m.insert((6, 14, 1), vec!["combinatorial P (P6)"]);
        m.insert((6, 14, -1), vec!["combinatorial P (P6)"]);
        m.insert((6, 15, 1), vec!["combinatorial I (I11)"]);
        m.insert((6, 15, -1), vec!["combinatorial I (I5)"]);
        m.insert((6, 16, 1), vec!["combinatorial I (I3)"]);
        m.insert((6, 16, -1), vec!["combinatorial I (I1)", "quasi raga Megha"]);
        m.insert((6, 17, 1), vec!["all tri-chord hexachord"]);
        m.insert((6, 17, -1), vec!["all tri-chord hexachord (inverted form)"]);
        m.insert((6, 18, 1), vec!["combinatorial I (I11)"]);
        m.insert((6, 18, -1), vec!["combinatorial I (I5)"]);
        m.insert((6, 20, 0), vec!["E all combinatorial (P2, P6, P10, I3, I7, R4, R8, RI1, RI5, RI9)", "Messiaen's truncated mode 3", "Genus tertium", "third-order all combinatorial"]);
        m.insert((6, 21, 1), vec!["combinatorial I (I1)"]);
        m.insert((6, 21, -1), vec!["combinatorial I (I3)"]);
        m.insert((6, 22, 1), vec!["combinatorial I (I11)"]);
        m.insert((6, 22, -1), vec!["combinatorial I (I5)"]);
        m.insert((6, 23, 0), vec!["combinatorial RI (RI8)", "super-locrian hexamirror"]);
        m.insert((6, 24, -1), vec!["melodic-minor hexachord"]);
        m.insert((6, 25, 1), vec!["locrian hexachord"]);
        m.insert((6, 25, -1), vec!["minor hexachord"]);
        m.insert((6, 26, 0), vec!["phrygian hexamirror", "combinatorial RI (RI8)"]);
        m.insert((6, 27, 1), vec!["combinatorial I (I11)"]);
        m.insert((6, 27, -1), vec!["combinatorial I (I1)", "pyramid hexachord"]);
        m.insert((6, 28, 0), vec!["double-phrygian hexachord", "combinatorial RI (RI6)"]);
        m.insert((6, 29, 0), vec!["combinatorial RI (RI9)"]);
        m.insert((6, 30, 1), vec!["Messiaen's truncated mode 2", "minor-bitonal hexachord", "combinatorial R (R6)", "combinatorial I (I1, I7)"]);
        m.insert((6, 30, -1), vec!["Stravinsky's Petrushka-chord", "Messiaen's truncated mode 2", "major-bitonal hexachord", "combinatorial R (R6)", "combinatorial I (I1, I7)"]);
        m.insert((6, 31, 1), vec!["combinatorial I (I7)"]);
        m.insert((6, 31, -1), vec!["combinatorial I (I11)"]);
        m.insert((6, 32, 0), vec!["Guidonian hexachord", "C all combinatorial (P6, I3, RI9)", "major hexamirror", "quartal hexamirror", "first-order all combinatorial"]);
        m.insert((6, 33, 1), vec!["dorian hexachord", "combinatorial I (I6)"]);
        m.insert((6, 33, -1), vec!["dominant-eleventh", "lydian hexachord", "combinatorial I (I1)"]);
        m.insert((6, 34, 1), vec!["Scriabin's Mystic-chord", "Prometheus hexachord", "combinatorial I (I11)"]);
        m.insert((6, 34, -1), vec!["augmented-eleventh", "harmonic hexachord", "combinatorial I (I7)"]);
        m.insert((6, 35, 0), vec!["whole tone scale", "6 equal part division", "F all-combinatorial (P1, P3, P5, P7, P9, P11, I1, I3, I5, I7, I9, I11, R2, R4, R6, R8, R10, RI2, RI4, RI6, RI8, RI10)", "Messiaen's mode 1", "sixth-order all combinatorial"]);
        m.insert((6, 37, 0), vec!["combinatorial RI (RI4)"]);
        m.insert((6, 38, 0), vec!["combinatorial RI (RI3)"]);
        m.insert((6, 42, 0), vec!["combinatorial RI (RI3)"]);
        m.insert((6, 43, 1), vec!["complement of all tri-chord hexachord"]);
        m.insert((6, 43, -1), vec!["complement of all-tri-chord hexachord (inverted form)"]);
        m.insert((6, 44, 1), vec!["Schoenberg Anagram hexachord"]);
        m.insert((6, 44, -1), vec!["quasi raga Bauli"]);
        m.insert((6, 45, 0), vec!["combinatorial RI (RI6)"]);
        m.insert((6, 47, -1), vec!["blues scale"]);
        m.insert((6, 48, 0), vec!["combinatorial RI (RI2)"]);
        m.insert((6, 49, 0), vec!["combinatorial RI (RI4)", "Prometheus Neapolitan mode"]);
        m.insert((6, 50, 0), vec!["combinatorial RI (RI1)"]);
        m.insert((7, 1, 0), vec!["chromatic heptamirror"]);
        m.insert((7, 16, 1), vec!["Debussy's heptatonic"]);
        m.insert((7, 20, 1), vec!["chromatic phrygian inverse"]);
        m.insert((7, 20, -1), vec!["Greek chromatic", "chromatic mixolydian", "chromatic dorian", "quasi raga Pantuvarali", "mela Kanakangi"]);
        m.insert((7, 21, -1), vec!["Roma (Gypsy) hepatonic"]);
        m.insert((7, 22, 0), vec!["double harmonic scale", "major Roma (Gypsy)", "Hungarian minor", "double harmonic scale", "quasi raga Mayamdavagaula"]);
        m.insert((7, 23, -1), vec!["tritone major heptachord"]);
        m.insert((7, 24, -1), vec!["mystic heptachord", "Enigmatic heptatonic"]);
        m.insert((7, 27, -1), vec!["modified blues"]);
        m.insert((7, 30, 1), vec!["Neapolitan-minor mode"]);
        m.insert((7, 31, 1), vec!["alternating heptachord", "Hungarian major mode"]);
        m.insert((7, 31, -1), vec!["diminished scale", "alternating heptachord"]);
        m.insert((7, 32, 1), vec!["harmonic minor scale", "harmonic minor collection", "Spanish Roma (Gypsy)", "mela Kiravani"]);
        m.insert((7, 32, -1), vec!["harmonic major scale (inverted)", "harmonic minor collection (inverted)", "mela Cakravana", "quasi raga Ahir Bhairav"]);
        m.insert((7, 33, 0), vec!["Neapolitan-major mode", "leading-whole-tone mode"]);
        m.insert((7, 34, 0), vec!["melodic minor ascending scale", "jazz minor", "augmented thirteenth heptamirror", "harmonic/super-locrian"]);
        m.insert((7, 35, 0), vec!["major scale", "major diatonic heptachord", "natural minor scale", "dominant thirteenth", "locrian", "phrygian", "major inverse"]);
        m.insert((8, 1, 0), vec!["chromatic octamirror"]);
        m.insert((8, 9, 0), vec!["Messiaen's mode 4"]);
        m.insert((8, 11, -1), vec!["blues octatonic"]);
        m.insert((8, 13, 1), vec!["blues octatonic"]);
        m.insert((8, 16, -1), vec!["enigmatic octachord"]);
        m.insert((8, 22, -1), vec!["Spanish octatonic scale"]);
        m.insert((8, 23, 0), vec!["Greek", "quartal octachord", "diatonic octad"]);
        m.insert((8, 25, 0), vec!["Messiaen's mode 6"]);
        m.insert((8, 26, 0), vec!["Spanish phrygian", "blues"]);
        m.insert((8, 28, 0), vec!["octatonic scale", "Messiaen's mode 2", "alternating octatonic scale", "diminished scale"]);
        m.insert((9, 1, 0), vec!["chromatic nonamirror"]);
        m.insert((9, 7, 1), vec!["nonatonic blues"]);
        m.insert((9, 11, -1), vec!["diminishing nonachord"]);
        m.insert((9, 12, 0), vec!["Messiaen's mode 3", "Tsjerepnin"]);
        m.insert((10, 1, 0), vec!["chromatic decamirror"]);
        m.insert((10, 5, 0), vec!["major-minor mixed"]);
        m.insert((10, 6, 0), vec!["Messiaen's mode 7"]);
        m.insert((11, 1, 0), vec!["chromatic undecamirror"]);
        m.insert((12, 1, 0), vec!["aggregate", "dodecachord", "twelve-tone chromatic", "chromatic scale", "dodecamirror"]);
        m
    };
}
// END_GENERATED_CODE
